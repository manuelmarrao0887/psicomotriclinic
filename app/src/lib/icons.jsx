/* Icon set — sans-serif, 1.6 stroke, currentColor */
export const Icon = ({ name, size = 20, color = "currentColor", strokeWidth = 1.6 }) => {
  ...
  switch (name) {
    ...
    case "warn":      return (<svg {...p}><path d="M10.29 3.86L1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0z"/><path d="M12 9v4M12 17h.01"/></svg>);
    ...
    case "question":  return (<svg {...p}><circle cx="12" cy="12" r="9"/><path d="M9.5 9a2.5 2.5 0 1 1 3.5 2.3c-.8.4-1 1-1 1.7M12 17h.01"/></svg>);
