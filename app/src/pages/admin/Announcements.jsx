      ...
      <Modal open={modal === "addAnnouncement"} onClose={() => setModal(null)} title="Nova comunicação" eyebrow="— PUBLICAR" width={560}>
        ...
        <Field label="Mensagem">
          <textarea
            ...
            style={{ width: "100%", padding: "11px 14px", borderRadius: 10, border: "1px solid #D9D3C5", fontSize: 14, background: "#FFFFFF", minHeight: 110, resize: "vertical", fontFamily: "inherit" }}
          />
        </Field>
