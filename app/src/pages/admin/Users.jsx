...
export default function Users() {
  ...
  return (
    <div style={{ padding: "28px 40px 60px" }}>
      ...
      <Card pad={0}>
        <div style={{ display: "grid", gridTemplateColumns: "60px 2fr 2fr 1fr 1fr", padding: "14px 20px", background: "#F5F2EC", borderBottom: "1px solid #EAE6DD" }}>
    ...
    <div style={{ padding: "28px 40px 60px" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "320px 1fr", gap: 24 }}>
        <Card pad={28} style={{ textAlign: "center", height: "fit-content" }}>
          <Av t={u.full_name?.split(" ").map((w) => w[0]).join("").slice(0, 2) || "?"} bg={u.role === "director" ? "#F5F2EC" : "#DCE7F0"} sz={88} />
          ...
          {u.email !== profile?.email && (
            <div style={{ marginTop: 24, paddingTop: 20, borderTop: "1px solid #F5F2EC", display: "flex", flexDirection: "column", gap: 10 }}>
              {u.active === false
